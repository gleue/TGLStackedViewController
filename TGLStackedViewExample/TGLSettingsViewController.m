...
- (void)viewDidLoad {
    ...
    NSArray *stackedRows = @[ @{ TGLSettingsRowTypeKey: TGLSettingsRowTypeStepper, TGLSettingsStepperRowTitleFormatKey: @"%@ Top Margin", TGLSettingsStepperRowNumberStyleKey: @(NSNumberFormatterDecimalStyle), TGLSettingsRowDefaultValueKey: @(20), TGLSettingsStepperRowMinValueKey: @(0), TGLSettingsStepperRowMaxValueKey: @(200), TGLSettingsRowKeyPathKey: @"%S.stackedLayoutMargin.top" },
    ...
    NSArray *exposedRows = @[ @{ TGLSettingsRowTypeKey: TGLSettingsRowTypeStepper, TGLSettingsStepperRowTitleFormatKey: @"%@ Top Margin", TGLSettingsStepperRowNumberStyleKey: @(NSNumberFormatterDecimalStyle), TGLSettingsRowDefaultValueKey: @(40), TGLSettingsStepperRowMinValueKey: @(0), TGLSettingsStepperRowMaxValueKey: @(200), TGLSettingsRowKeyPathKey: @"%S.exposedLayoutMargin.top" },
